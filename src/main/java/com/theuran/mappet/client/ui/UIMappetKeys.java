...
public class UIMappetKeys {
    public static final IKey STATES_TITLE = L10n.lang("mappet.server.settings.states.title");
    public static final IKey STATES_PLAYER_TITLE = L10n.lang("mappet.server.settings.states.player.title");
    public static final IKey STATES_PICK = L10n.lang("mappet.server.settings.states.pick");
